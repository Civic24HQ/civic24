...
- The old baselines (`goldens/*.png`, 19 images) were deleted and replaced by 19 readable `goldens/macos/<name>.png` and 19 portable `goldens/ci/<name>.png`. Names are now snake case without spaces or dashes.
