  ...
  static ThemeData get lightThemeData {
    return FlexThemeData.light(
      ...
      colorScheme: SeedColorScheme.fromSeeds(
        ...
        primaryContainer: AppColors.primary.shade100,
        ...
        inversePrimary: AppColors.primary.shade300,
  ...
  static ThemeData get darkThemeData {
    return FlexThemeData.dark(
      ...
      colorScheme: SeedColorScheme.fromSeeds(
        ...
        onPrimaryContainer: AppColors.primary.shade100,
        primaryFixed: AppColors.primary.shade700,
        primaryFixedDim: AppColors.black,
        inversePrimary: AppColors.primary.shade900,
        secondary: AppColors.secondary,
        onSecondary: AppColors.white,
