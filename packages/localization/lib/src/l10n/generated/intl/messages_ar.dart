...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(action) => "اضغط لـ ${action}";

  static String m1(version) => "(v${version})";

  static String m2(emailValue) =>
      "تم إرسال بريد إلكتروني لإعادة تعيين كلمة المرور إلى ${emailValue}. يرجى التحقق من صندوق الوارد واتباع التعليمات لإعادة تعيين كلمة المرور.";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "featureAddReport": MessageLookupByLibrary.simpleMessage("أضف تقريرًا"),
    ...
    "featureCategoryTypeAbandonedDescription":
        MessageLookupByLibrary.simpleMessage(
          "أبلغ عن مشاريع حكومية/مجتمعية غير مكتملة أو مهجورة في منطقتك.",
        ),
    "featureCategoryTypeDetailedAbandoned":
        MessageLookupByLibrary.simpleMessage("مشاريع مهجورة وغير مكتملة"),
    "featureCategoryTypeDetailedEducation":
        MessageLookupByLibrary.simpleMessage("التعليم والمرافق العامة"),
    "featureCategoryTypeDetailedGovernance":
        MessageLookupByLibrary.simpleMessage("الحكم"),
    ...
    "featureCategoryTypeEducationDescription":
        MessageLookupByLibrary.simpleMessage(
          "أبلغ عن مبان مدرسية متدهورة، قاعات مجتمع مغلقة أو مكتبات مهملة.",
        ),
    ...
    "featureCategoryTypeGovernanceDescription":
        MessageLookupByLibrary.simpleMessage(
          "أبلغ عن قضايا مثل تأخيرات حكومية، سوء تقديم الخدمات، ممارسات فاسدة أو إساءة استخدام الأموال العامة.",
        ),
    ...
    "featureCategoryTypeLightDescription": MessageLookupByLibrary.simpleMessage(
      "أبلغ عن أعمدة إنارة معطلة، أسلاك مكشوفة، أو انقطاع التيار يؤثر على الأماكن العامة والسلامة.",
    ),
    ...
    "featureCategoryTypeRoadDescription": MessageLookupByLibrary.simpleMessage(
      "أبلغ عن الحفر، الطرق المتهالكة، الأرصفة المحطمة، إشارات المرور المعطلة أو القيادة المتهورة في منطقتك.",
    ),
    ...
    "featureCategoryTypeUrbanDescription": MessageLookupByLibrary.simpleMessage(
      "أبلغ عن إقامات غير مرخّصة، التلوث الضوضائي، إساءة استخدام الأراضي أو انتهاكات التخطيط في منطقتك.",
    ),
    ...
    "featureCategoryTypeWasteDescription": MessageLookupByLibrary.simpleMessage(
      "أبلغ عن نفايات غير مجمعة، مصارف مسدودة، تفريغ غير قانوني أو مخاوف بيئية أخرى.",
    ),
    ...
    "featureForgotPasswordHint": MessageLookupByLibrary.simpleMessage(
      "ابدأ عملية إعادة التعيين بملء بريدك الإلكتروني",
    ),
    ...
    "featureMyReports": MessageLookupByLibrary.simpleMessage("تقاريري"),
    "featureNotificationEmpty": MessageLookupByLibrary.simpleMessage(
      "ليس لديك أية إشعارات",
    ),
    "featureNotificationInstruction": MessageLookupByLibrary.simpleMessage(
      "تعليم الكل كمقروء",
    ),
    "featureNotifications": MessageLookupByLibrary.simpleMessage("الإشعارات"),
    ...
    "featureOnboardingConnectVoiceDesc": MessageLookupByLibrary.simpleMessage(
      "يوفر Civic24 منصة للتفاعل مع المواطنين الآخرين عبر التعبير عن رأيك في القضايا المدنية",
    ),
    ...
    "featureOnboardingVoiceCountDesc": MessageLookupByLibrary.simpleMessage(
      "مع Civic24، يساعد تأييدك في ترتيب أولويات القضايا المدنية المهمة لمن حولك",
    ),
    ...
    "featureOnboardingVoiceReportDesc": MessageLookupByLibrary.simpleMessage(
      "يتيح لك Civic24 التعبير عن المشاكل الملحّة في مجتمعك وإيصال صوتك",
    ),
    "featureProfileAccountEmail": MessageLookupByLibrary.simpleMessage(
      "لا يمكن تغيير بريد حسابك الإلكتروني.",
    ),
    "featureReports": MessageLookupByLibrary.simpleMessage("التقارير"),
    "featureSettingsAbout": MessageLookupByLibrary.simpleMessage("حول"),
    "featureSettingsAppearance": MessageLookupByLibrary.simpleMessage("المظهر"),
    ...
    "featureSettingsAppearanceDarkDesc": MessageLookupByLibrary.simpleMessage(
      "احتفظ بالتطبيق في الوضع الداكن",
    ),
    ...
    "featureSettingsAppearanceLightDesc": MessageLookupByLibrary.simpleMessage(
      "احتفظ بالتطبيق في الوضع الفاتح",
    ),
    ...
    "featureSettingsAppearanceSystemDesc": MessageLookupByLibrary.simpleMessage(
      "يتكيف تلقائيًا مع إعدادات مظهر جهازك",
    ),
    "featureSettingsEditProfile": MessageLookupByLibrary.simpleMessage(
      "تعديل الملف الشخصي",
    ),
    "featureSettingsLanguage": MessageLookupByLibrary.simpleMessage("اللغة"),
    ...
    "featureSettingsLoggingOutHint": MessageLookupByLibrary.simpleMessage(
      "هل أنت متأكد أنك تريد تسجيل الخروج من حسابك على هذا الجهاز؟",
    ),
    ...
    "featureSettingsSecurityAppleLinkedDesc":
        MessageLookupByLibrary.simpleMessage("Apple ID متاح لتسجيل الدخول"),
    "featureSettingsSecurityAppleUnlinkDesc":
        MessageLookupByLibrary.simpleMessage(
          "اربط Apple ID الخاص بك لتسجيل دخول آمن",
        ),
    "featureSettingsSecurityGoogle": MessageLookupByLibrary.simpleMessage(
      "Google",
    ),
    "featureSettingsSecurityGoogleLinkedDesc":
        MessageLookupByLibrary.simpleMessage("حساب Google متاح لتسجيل الدخول"),
    "featureSettingsSecurityGoogleUnlinkDesc":
        MessageLookupByLibrary.simpleMessage(
          "اربط حساب Google الخاص بك لتسجيل دخول آمن",
        ),
    "featureSettingsSecurityResetPassword":
        MessageLookupByLibrary.simpleMessage("تغيير كلمة المرور"),
    "featureSettingsSecurityResetPasswordDesc":
        MessageLookupByLibrary.simpleMessage("قم بتحديث كلمة مرورك الحالية"),
    ...
    "featureSignUpSuccessHint": MessageLookupByLibrary.simpleMessage(
      "استعد لاستكشاف الميزات الرائعة التي يقدمها Civic24.",
    ),
    "featureonboardingGetStarted": MessageLookupByLibrary.simpleMessage(
      "البدء",
    ),
    "generalAddComment": MessageLookupByLibrary.simpleMessage("أضف تعليقًا"),
    "generalAllIssues": MessageLookupByLibrary.simpleMessage("كل القضايا"),
    "generalCancel": MessageLookupByLibrary.simpleMessage("إلغاء"),
    "generalCategory": MessageLookupByLibrary.simpleMessage("الفئة"),
    "generalClickToUpload": MessageLookupByLibrary.simpleMessage(
      "انقر للتحميل",
    ),
    "generalClose": MessageLookupByLibrary.simpleMessage("إغلاق"),
    "generalComment": MessageLookupByLibrary.simpleMessage("التعليقات"),
    "generalConfirmPassword": MessageLookupByLibrary.simpleMessage(
      "تأكيد كلمة المرور",
    ),
    "generalContinue": MessageLookupByLibrary.simpleMessage("متابعة"),
    ...
    "generalCountry": MessageLookupByLibrary.simpleMessage("البلد"),
    "generalDeleteAccountButton": MessageLookupByLibrary.simpleMessage(
      "حذف الحساب",
    ),
    "generalEdit": MessageLookupByLibrary.simpleMessage("تعديل"),
    ...
    "generalFirstname": MessageLookupByLibrary.simpleMessage("الاسم الأول"),
    "generalForgotPassword": MessageLookupByLibrary.simpleMessage(
      "هل نسيت كلمة المرور؟",
    ),
    "generalLastname": MessageLookupByLibrary.simpleMessage("اسم العائلة"),
    "generalLogin": MessageLookupByLibrary.simpleMessage("تسجيل الدخول"),
    "generalLogout": MessageLookupByLibrary.simpleMessage("تسجيل الخروج"),
    "generalNoResults": MessageLookupByLibrary.simpleMessage("لا توجد نتائج"),
    "generalPassword": MessageLookupByLibrary.simpleMessage("كلمة المرور"),
    "generalPrevious": MessageLookupByLibrary.simpleMessage("السابق"),
    "generalProceed": MessageLookupByLibrary.simpleMessage("استمر"),
    "generalRequired": MessageLookupByLibrary.simpleMessage("مطلوب"),
    ...
    "generalSave": MessageLookupByLibrary.simpleMessage("حفظ"),
    "generalSearch": MessageLookupByLibrary.simpleMessage("ابحث هنا"),
    "generalSelectCountry": MessageLookupByLibrary.simpleMessage("اختر بلدًا"),
    "generalSelectState": MessageLookupByLibrary.simpleMessage("اختر ولاية"),
    "generalSignUp": MessageLookupByLibrary.simpleMessage("إنشاء حساب"),
    "generalState": MessageLookupByLibrary.simpleMessage("الولاية"),
    "generalSubmit": MessageLookupByLibrary.simpleMessage("إرسال"),
    "generalSupportedFormats": MessageLookupByLibrary.simpleMessage(
      "الصيغ المدعومة: jpg, png, mp4 (الحد الأقصى 800x400px)",
    ),
    "generalTakePicture": MessageLookupByLibrary.simpleMessage("التقاط صورة"),
    "generalTrending": MessageLookupByLibrary.simpleMessage("الشائع"),
    "generalUploadFile": MessageLookupByLibrary.simpleMessage("تحميل ملف"),
    "generalUseAccurateLocation": MessageLookupByLibrary.simpleMessage(
      "استخدم الموقع الدقيق",
    ),
    ...
    "pageHome": MessageLookupByLibrary.simpleMessage("الرئيسية"),
    "pageNotifications": MessageLookupByLibrary.simpleMessage("الإشعارات"),
    "pageReports": MessageLookupByLibrary.simpleMessage("التقارير"),
    "pageSettings": MessageLookupByLibrary.simpleMessage("الإعدادات"),
