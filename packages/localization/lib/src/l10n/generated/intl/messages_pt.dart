...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(emailValue) =>
      "Um e-mail para redefinir sua senha foi enviado para ${emailValue}. Verifique sua caixa de entrada e siga as instruções para redefinir sua senha.";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "featureAddReportCategory": MessageLookupByLibrary.simpleMessage(
      "Selecione a categoria do relatório",
    ),
    ...
    "featureCategoryTypeDetailedEducation":
        MessageLookupByLibrary.simpleMessage("Educação e instalações públicas"),
    "featureCategoryTypeDetailedGovernance":
        MessageLookupByLibrary.simpleMessage("Governança"),
    ...
    "featureCategoryTypeDetailedLight": MessageLookupByLibrary.simpleMessage(
      "Problemas de iluminação e eletricidade",
    ),
    "featureCategoryTypeDetailedRoad": MessageLookupByLibrary.simpleMessage(
      "Problemas de estradas e transporte",
    ),
    ...
    "featureCategoryTypeDetailedUrban": MessageLookupByLibrary.simpleMessage(
      "Planejamento urbano e violações de zoneamento",
    ),
    "featureCategoryTypeDetailedWaste": MessageLookupByLibrary.simpleMessage(
      "Lixo e riscos ambientais",
    ),
    ...
    "featureCategoryTypeGovernanceDescription":
        MessageLookupByLibrary.simpleMessage(
          "Reporte problemas como atrasos administrativos, prestação de serviços inadequada, práticas corruptas ou uso indevido de fundos públicos.",
        ),
    ...
    "featureCategoryTypeLightDescription": MessageLookupByLibrary.simpleMessage(
      "Reporte postes quebrados, fios expostos ou quedas de energia que afetam espaços públicos e a segurança.",
    ),
    ...
    "featureCategoryTypeRoadDescription": MessageLookupByLibrary.simpleMessage(
      "Reporte buracos, estradas ruins, calçadas quebradas, semáforos defeituosos ou direção imprudente em sua área.",
    ),
    ...
    "featureCategoryTypeUrbanDescription": MessageLookupByLibrary.simpleMessage(
      "Reporte construções não autorizadas, poluição sonora, uso indevido de terrenos ou violações de zoneamento em sua área.",
    ),
    "featureCategoryTypeWaste": MessageLookupByLibrary.simpleMessage("Lixo"),
    "featureCategoryTypeWasteDescription": MessageLookupByLibrary.simpleMessage(
      "Reporte lixo não coletado, ralos entupidos, descarte ilegal ou outras preocupações ambientais.",
    ),
    ...
    "featureForgotPasswordHint": MessageLookupByLibrary.simpleMessage(
      "Inicie a redefinição preenchendo seu e-mail",
    ),
    ...
    "featureOnboardingConnectVoice": MessageLookupByLibrary.simpleMessage(
      "Conecte-se com outras vozes",
    ),
    "featureOnboardingConnectVoiceDesc": MessageLookupByLibrary.simpleMessage(
      "O Civic24 oferece uma plataforma para você interagir com outros cidadãos expressando sua opinião sobre questões cívicas",
    ),
    ...
    "featureOnboardingVoiceCountDesc": MessageLookupByLibrary.simpleMessage(
      "Com o Civic24, seu voto ajuda a priorizar os problemas cívicos que mais importam para as pessoas ao seu redor",
    ),
    "featureOnboardingVoiceReport": MessageLookupByLibrary.simpleMessage(
      "Dê voz ao seu relato",
    ),
    "featureOnboardingVoiceReportDesc": MessageLookupByLibrary.simpleMessage(
      "O Civic24 permite que você fale sobre problemas urgentes em sua comunidade e faça sua voz ser ouvida",
    ),
    ...
    "featureSignUpSuccessHint": MessageLookupByLibrary.simpleMessage(
      "Prepare-se para explorar os incríveis recursos do Civic24.",
    ),
    ...
    "generalCategory": MessageLookupByLibrary.simpleMessage("Categoria"),
    "generalClickToUpload": MessageLookupByLibrary.simpleMessage(
      "Clique para enviar",
    ),
    "generalClose": MessageLookupByLibrary.simpleMessage("Fechar"),
    "generalComment": MessageLookupByLibrary.simpleMessage("Comentários"),
    ...
    "generalEmail": MessageLookupByLibrary.simpleMessage("Endereço de e-mail"),
    ...
    "generalFirstname": MessageLookupByLibrary.simpleMessage("Nome"),
    "generalForgotPassword": MessageLookupByLibrary.simpleMessage(
      "Esqueceu a senha?",
    ),
    "generalLastname": MessageLookupByLibrary.simpleMessage("Sobrenome"),
    "generalLogin": MessageLookupByLibrary.simpleMessage("Entrar"),
    "generalLogout": MessageLookupByLibrary.simpleMessage("Sair"),
    "generalNoResults": MessageLookupByLibrary.simpleMessage(
      "Nenhum resultado",
    ),
    "generalPassword": MessageLookupByLibrary.simpleMessage("Senha"),
    "generalPrevious": MessageLookupByLibrary.simpleMessage("Anterior"),
    "generalProceed": MessageLookupByLibrary.simpleMessage("Prosseguir"),
    "generalRequired": MessageLookupByLibrary.simpleMessage("Obrigatório"),
    ...
    "generalResetPasswordButtonText": MessageLookupByLibrary.simpleMessage(
      "Abrir o app de e-mail",
    ),
    "generalResetPasswordDesc": m2,
    "generalSave": MessageLookupByLibrary.simpleMessage("Salvar"),
    "generalSearch": MessageLookupByLibrary.simpleMessage("Pesquisar aqui"),
    ...
    "generalSignUp": MessageLookupByLibrary.simpleMessage("Cadastrar-se"),
    "generalState": MessageLookupByLibrary.simpleMessage("Estado/Região"),
    "generalSubmit": MessageLookupByLibrary.simpleMessage("Enviar"),
    "generalSupportedFormats": MessageLookupByLibrary.simpleMessage(
      "Suportado: jpg, png, mp4 (máx. 800x400px)",
    ),
    "generalTakePicture": MessageLookupByLibrary.simpleMessage(
      "Tirar uma foto",
    ),
    "generalTrending": MessageLookupByLibrary.simpleMessage("Em alta"),
    "generalUploadFile": MessageLookupByLibrary.simpleMessage("Enviar arquivo"),
    ...
    "pageHome": MessageLookupByLibrary.simpleMessage("Início"),
    "pageNotifications": MessageLookupByLibrary.simpleMessage("Notificações"),
    "pageReports": MessageLookupByLibrary.simpleMessage("Relatórios"),
    "pageSettings": MessageLookupByLibrary.simpleMessage("Configurações"),
