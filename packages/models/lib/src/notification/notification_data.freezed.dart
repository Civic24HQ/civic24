...
/// parsed when converted from Firestore
 String? get path;/// The type of the notification, used for determining the description text and deep linking.
 NotificationType get type;/// The userId of the person who triggered the action (liker, etc.)
 String? get actorUserId;/// Display name of the actor for the description text.
 String? get actorName;/// The report this notification is about — used for deep linking.
 String? get reportId;
...
@useResult
$Res call({
 String notificationId, String title, String description,@TimestampConverter() DateTime createdAt,@TimestampConverter() DateTime updatedAt, bool hasBeenSeen, String? userId, String? notificationIconData, String? path, NotificationType type, String? actorUserId, String? actorName, String? reportId
});
...
as NotificationType,actorUserId: freezed == actorUserId ? _self.actorUserId : actorUserId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String notificationId,  String title,  String description, @TimestampConverter()  DateTime createdAt, @TimestampConverter()  DateTime updatedAt,  bool hasBeenSeen,  String? userId,  String? notificationIconData,  String? path,  NotificationType type,  String? actorUserId,  String? actorName,  String? reportId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationData() when $default != null:
return $default(_that.notificationId,_that.title,_that.description,_that.createdAt,_that.updatedAt,_that.hasBeenSeen,_that.userId,_that.notificationIconData,_that.path,_that.type,_that.actorUserId,_that.actorName,_that.reportId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String notificationId,  String title,  String description, @TimestampConverter()  DateTime createdAt, @TimestampConverter()  DateTime updatedAt,  bool hasBeenSeen,  String? userId,  String? notificationIconData,  String? path,  NotificationType type,  String? actorUserId,  String? actorName,  String? reportId)  $default,) {final _that = this;
switch (_that) {
case _NotificationData():
return $default(_that.notificationId,_that.title,_that.description,_that.createdAt,_that.updatedAt,_that.hasBeenSeen,_that.userId,_that.notificationIconData,_that.path,_that.type,_that.actorUserId,_that.actorName,_that.reportId);case _:
  throw StateError('Unexpected subclass');
...
class _NotificationData extends NotificationData {
  const _NotificationData({required this.notificationId, required this.title, required this.description, @TimestampConverter() required this.createdAt, @TimestampConverter() required this.updatedAt, this.hasBeenSeen = false, this.userId, this.notificationIconData, this.path, this.type = NotificationType.unknown, this.actorUserId, this.actorName, this.reportId}): super._();
...
/// Create a copy of NotificationData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? notificationId = null,Object? title = null,Object? description = null,Object? createdAt = null,Object? updatedAt = null,Object? hasBeenSeen = null,Object? userId = freezed,Object? notificationIconData = freezed,Object? path = freezed,Object? type = null,Object? actorUserId = freezed,Object? actorName = freezed,Object? reportId = freezed,}) {
