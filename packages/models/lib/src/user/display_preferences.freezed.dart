...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DisplayPreferences&&(identical(other.language, _this.language) || other.language == _this.language)&&(identical(other.themeModeIndex, _this.themeModeIndex) || other.themeModeIndex == _this.themeModeIndex));
}
...
int get hashCode {
  final _this = this as DisplayPreferences;
  return Object.hash(runtimeType,_this.language,_this.themeModeIndex);
}

@override
String toString() {
  final _this = this as DisplayPreferences;
  return 'DisplayPreferences(language: ${_this.language}, themeModeIndex: ${_this.themeModeIndex})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,language,themeModeIndex);
}
